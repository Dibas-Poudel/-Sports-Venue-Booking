      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {loading ? (
         <Spinner/>
          ...
          <div className="text-center text-gray-400 text-lg">No PlayStation games available.</div>
        ) : (
            ...
            {playstationGames.map((game) => (
              ...
              >
                ...
                <div className="p-4 lg:hidden">
                  ...
                  <p className="text-gray-300 text-sm mb-1">{game.description}</p>
                  <p className="text-white font-semibold mb-3">Price: Rs {game.price}</p>
                  <Link
                ...
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center p-6 opacity-0 group-hover:opacity-100 transition duration-300">
                  ...
                  <p className="text-white font-semibold mb-4">Price: Rs {game.price}</p>
                  <Link
                    to={`/book/${game.name.toLowerCase().replace(/\s+/g, '-')}`}
